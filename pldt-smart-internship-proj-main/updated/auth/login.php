...
<body>
    <div class="container">
        ...
        <hr class="divider"/>
        <br>
        <form action="auth.php?authType=login" method="POST">
        ...
        <p class="text-center text-secondary mt-4">
            Don't have an account? <a href="register.php" class="text-primary">Register as User!</a><br>
            Or <a href="registerAdmin.php" class="text-primary">Register as Admin!</a>
        </p>
    </div>
</body>
</html>
